...
<body>
	...
	<div class="content">
		...
		<form action="Controller">
			<input type="hidden" name="command" value="announcementwriteaction">
			<div class="writingTitle">
				<textarea placeholder="제목" maxlength="50" name="title"></textarea>
			</div>
  			<div class="writingContent">
				<textarea placeholder="내용" maxlength="5000" name="content"></textarea>
			</div>
