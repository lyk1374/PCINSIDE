...
<%
	...
	AnnouncementDto writing = (AnnouncementDto)(request.getAttribute("writing"));
...
<meta charset="UTF-8">
<title>피시인사이드</title>
<link rel="stylesheet" href="css/announcementShowStyle.css">
...
<body>
	...
	<div class="board_wrap">
		<div class="title2">
		<span class="titleTxt01">공지사항</span> <span class="pageLocate">
		...
		<div class="board_list_Wrap">
			...
			<div class="bt_wrap">
				...
				<%if(admin) {%>
					<a href="Controller?command=announcementmodify&bno=<%=bno%>">수정</a>
					<a href="Controller?command=announcementdelete&bno=<%=bno%>">삭제</a>
				<%} %>
			</div>
		</div>
	</div>
