...
<meta charset="UTF-8">
<title>피시인사이드</title>
<link rel="stylesheet" href="css/freeBoardWriteStyle.css">
	...
	<div class="content">
		<div class="title">
			...
			<span class="pageLocate">
				...
				<a href="Controller?command=freeboard&pageNum=1" class="page">공지사항</a>
			</span>
			<div style="margin-bottom: 20px;"></div>
			<div class="titleTxt02">소중한 의견을 나누어 주세요.</div>
		</div>
		<form action="Controller">
			<input type="hidden" name="command" value="freeboardmodifyaction">
			<div class="writingTitle">
				<textarea placeholder="제목" maxlength="50" name="title"><%=fDto.getTitle() %></textarea>
			</div>
  			<div class="writingContent">
				<textarea placeholder="내용" maxlength="5000" name="content"><%=fDto.getContent() %></textarea>
			</div>
