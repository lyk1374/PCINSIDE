...
<%
	AnnouncementDto aDto = (AnnouncementDto)(request.getAttribute("aDto"));
...
<meta charset="UTF-8">
<title>피시인사이드</title>
<link rel="stylesheet" href="css/announcementWriteStyle.css">
	...
	<div class="content">
		<div class="title">
			...
			<span class="pageLocate">
				<a href="Comtroller?command=main" class="page">홈</a>
			...
			<div class="titleTxt02">관리자용 공지사항 작성 페이지입니다.</div>
		</div>
		<form action="Controller">
			<input type="hidden" name="command" value="announcementmodifyaction">
			<div class="writingTitle">
				<textarea placeholder="제목" maxlength="50" name="title"><%=aDto.getTitle() %></textarea>
			</div>
  			<div class="writingContent">
				<textarea placeholder="내용" maxlength="5000" name="content"><%=aDto.getContent() %></textarea>
			</div>
